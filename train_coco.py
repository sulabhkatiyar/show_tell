...
# Data parameters
data_folder = 'path_to_dataset_folder'  # folder with data files saved by create_input_files_coco.py
...
print_freq = 5000  # print training/validation stats every __ batches
fine_tune_encoder = False  # fine-tune encoder?
checkpoint = None # path to checkpoint 'BEST_checkpoint_coco_5_cap_per_img_1_min_word_freq.pth.tar', None if none
